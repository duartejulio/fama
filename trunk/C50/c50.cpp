...
float C50::TrialTreeCost(Boolean FirstTime)
/*    -------------  */
{
    Attribute	Att;
...
float C50::ErrCost(Tree T, CaseNo Fp, CaseNo Lp)
/*    -------  */
{
    CaseNo	i;
    float	ErrCost=0;
...
void C50::ScanTree(Tree T, Boolean *Used)
/*   --------  */
{
    DiscrValue	v;
...
ClassNo C50::TreeClassify(DataRec Case, Tree DecisionTree)
/*      ------------  */
{
    ClassNo	c;
...
void C50::FindLeaf(DataRec Case, Tree T, Tree PT, float Fraction)
/*   --------  */
{
    DiscrValue	v, Dv;
    ClassNo	c;
...
void C50::FollowAllBranches(DataRec Case, Tree T, float Fraction)
/*   -----------------  */
{
    DiscrValue	v;
...
ClassNo C50::RuleClassify(DataRec Case, CRuleSet RS)
/*      ------------  */
{
    ClassNo	c, Best;
    float	TotWeight=0;
...
int C50::FindOutcome(DataRec Case, Condition OneCond)
/*  -----------  */
{
...
Boolean C50::Satisfies(DataRec Case, Condition OneCond)
/*      ---------  */
{
...
Boolean C50::Matches(CRule R, DataRec Case)
/*      -------  */
{
    int d;
...
void C50::CheckActiveSpace(int N)
/*   ----------------  */
{
    if ( ActiveSpace <= N )
    {
...
void C50::MarkActive(RuleTree RT, DataRec Case)
/*   ----------  */
{
    DiscrValue	v;
    int		ri;
...
void C50::CheckUtilityBand(int *u, RuleNo r, ClassNo Actual, ClassNo Default)
/*   ----------------  */
{
    ClassNo	c;
...
ClassNo C50::BoostClassify(DataRec Case, int MaxTrial)
/*	-------------  */
{
    ClassNo	c, Best;
    int		t;
...
ClassNo C50::SelectClass(ClassNo Default, Boolean UseCosts)
/*      -----------  */
{
...
ClassNo C50::Classify(DataRec Case)
/*      --------  */
{
...
float C50::Interpolate(Tree T, ContValue Val)
/*    -----------  */
{
...
void C50::FreeClassifier(int Trial)
/*   --------------  */
{
    if ( Raw )
    {
...
void C50::PrintConfusionMatrix(CaseNo *ConfusionMat)
/*   --------------------  */
{
...
void C50::PrintErrorBreakdown(CaseNo *ConfusionMat)
/*   -------------------  */
{
...
void C50::PrintUsageInfo(CaseNo *Usage)
/*   --------------  */
{
    Attribute	Att, Best;
    float	Tests;
...
void C50::EvaluateSingle(int Flags)
/*   --------------  */
{
...
void C50::EvaluateBoost(int Flags)
/*   -------------  */
{
    ClassNo	RealClass, PredClass;
    int		t;
...
void C50::RecordAttUsage(DataRec Case, int *Usage)
/*   --------------  */
{
    Attribute	Att;
    int		i;
...
void C50::EvalContinuousAtt(Attribute Att, CaseNo Fp, CaseNo Lp)
/*   -----------------  */
{
...
void C50::EstimateMaxGR(Attribute Att, CaseNo Fp, CaseNo Lp)
/*   -------------  */
{
    CaseNo	i, j;
...
void C50::PrepareForContin(Attribute Att, CaseNo Fp, CaseNo Lp)
/*   ----------------  */
{
    CaseNo	i;
    ClassNo	c;
...
CaseNo C50::PrepareForScan(CaseNo Lp)
/*     --------------  */
{
    CaseNo	i, j;
    ClassNo	c;
...
void C50::ContinTest(Tree Node, Attribute Att)
/*   ----------  */
{
    Sprout(Node, 3);
...
void C50::AdjustAllThresholds(Tree T)
/*   -------------------  */
{
    Attribute	Att;
    CaseNo	Ep;
...
void C50::AdjustThresholds(Tree T, Attribute Att, CaseNo *Ep)
/*   ----------------  */
{
    DiscrValue	v;
    CaseNo	i;
...
ContValue C50::GreatestValueBelow(ContValue Th, CaseNo *Ep)
/*	  ------------------  */
{
    CaseNo	Low, Mid, High;
...
void C50::EvalDiscreteAtt(Attribute Att, CaseCount Cases)
/*   ---------------  */
{
...
void C50::EvalOrderedAtt(Attribute Att, CaseCount Cases)
/*   --------------  */
{
    CaseCount	KnownCases;
...
void C50::SetDiscrFreq(Attribute Att)
/*   ------------  */
{
    ClassNo	c;
    DiscrValue	v;
...
double C50::DiscrKnownBaseInfo(CaseCount KnownCases, DiscrValue MaxVal)
/*     ------------------  */
{
    ClassNo	c;
...
void C50::DiscreteTest(Tree Node, Attribute Att)
/*   ------------  */
{
    int		S, Bytes;
    DiscrValue	v, CutV;
...
void C50::PruneRule(Condition Cond[], ClassNo TargetClass)
/*   ---------  */
{
...
void C50::AddToList(CaseNo *List, CaseNo N)
/*   ---------  */
{
    Succ[N] = *List;
    *List   = N;
...
void C50::DeleteFromList(CaseNo *Before, CaseNo N)
/*   --------------  */
{
    *Before = Succ[N];
}
...
void C50::Increment(int d, CaseNo i, double *Total, double *Errors)
/*   ---------  */
{
...
void C50::FormTree(CaseNo Fp, CaseNo Lp, int Level, Tree *Result)
/*   --------  */
{
...
void C50::SampleEstimate(CaseNo Fp, CaseNo Lp, CaseCount Cases)
/*   --------------  */
{
...
void C50::Sample(CaseNo Fp, CaseNo Lp, CaseNo N)
/*   ------  */
{
    CaseNo	i, j;
    double	Interval;
...
Attribute C50::ChooseSplit(CaseNo Fp, CaseNo Lp, CaseCount Cases, Boolean Sampled)
/*        -----------  */
{
    Attribute	Att;
    int		i, j;
...
void C50::ProcessQueue(CaseNo WFp, CaseNo WLp, CaseCount WCases)
/*   ------------  */
{
    Attribute	Att;
    float	GR;
...
Attribute C50::FindBestAtt(CaseCount Cases)
/*	  -----------  */
{
...
void C50::EvalDiscrSplit(Attribute Att, CaseCount Cases)
/*   --------------  */
{
    DiscrValue	v, NBr;
...
void C50::Divide(Tree T, CaseNo Fp, CaseNo Lp, int Level)
/*   ------  */
{
...
CaseNo C50::Group(DiscrValue V, CaseNo Bp, CaseNo Ep, Tree TestNode)
/*     -----  */
{
    CaseNo	i;
    Attribute	Att;
...
CaseCount C50::SumWeights(CaseNo Fp, CaseNo Lp)
/*        ----------  */
{
    double	Sum=0.0;
    CaseNo	i;
...
CaseCount C50::SumNocostWeights(CaseNo Fp, CaseNo Lp)
/*        ----------------  */
{
    double	Sum=0.0;
    CaseNo	i;
...
void C50::FindClassFreq(double *CF, CaseNo Fp, CaseNo Lp)
/*   -------------  */
{
    ClassNo	c;
    CaseNo	i;
...
void C50::FindAllFreq(CaseNo Fp, CaseNo Lp)
/*   -----------  */
{
    ClassNo	c;
    CaseNo	i;
...
void C50::GetData(FILE *Df, Boolean Train, Boolean AllowUnknownClass)
/*   -------  */
{
    DataRec	DVec;
...
DataRec C50::GetDataRec(FILE *Df, Boolean Train)
/*      ----------  */
{
    Attribute	Att;
...
void C50::CheckValue(DataRec DVec, Attribute Att)
/*   ----------  */
{
    ContValue	Cv;
...
Boolean C50::ReadName(FILE *f, String s, int n, char ColonOpt)
/*      --------  */
{
    register char *Sp=s;
    register int  c;
...
int C50::Which(String Val, String *List, int First, int Last)
/*  -----  */
{
    int	n=First;
...
void C50::ReadDefinition(FILE *f)
/*   --------------  */
{
...
void C50::DefSyntaxError(String Msg)
/*   --------------  */
{
    String	RestOfText;
    int		i=10;
...
void C50::DefSemanticsError(int Fi, String Msg, int OpCode)
/*   -----------------  */
{
...
void C50::Dump(char OpCode, ContValue F, String S, int Fi)
/*   ----  */
{
    if ( Buff[Fi] == ' ' ) Fi++;
...
void C50::DumpOp(char OpCode, int Fi)
/*   ------  */
{
...
Boolean C50::UpdateTStack(char OpCode, ContValue F, String S, int Fi)
/*      ------------  */
{
    if ( TSN >= TStackSize )
    {
...
AttValue C50::EvaluateDef(Definition D, DataRec Case)
/*       -----------  */
{
...
double C50::ComputeGain(double BaseInfo, float UnknFrac, DiscrValue MaxVal,
...
double C50::TotalInfo(double V[], DiscrValue MinVal, DiscrValue MaxVal)
/*     ---------  */
{
    DiscrValue	v;
...
void C50::PrintDistribution(Attribute Att, DiscrValue MinVal, DiscrValue MaxVal,
...
void C50::CheckFile(String Extension, Boolean Write)
/*   ---------  */
{
    static char	*LastExt="";
...
void C50::WriteFilePrefix(String Extension)
/*   ---------------  */
{
    time_t	clock;
    struct tm	*now;
...
void C50::ReadFilePrefix(String Extension)
/*   --------------  */
{
...
void C50::SaveTree(Tree T, String Extension)
/*   --------  */
{
...
void C50::SaveRules(CRuleSet RS, String Extension)
/*   ---------  */
{
    int		ri, d;
    CRule	R;
...
void C50::AsciiOut(String Pre, String S)
/*   --------  */
{
    fprintf(TRf, "%s\"", Pre);
    while ( *S )
...
Tree C50::GetTree(String Extension)
/*   -------  */
{
...
CRuleSet C50::GetRules(String Extension)
/*	 --------  */
{
    CheckFile(Extension, false);
...
String C50::RemoveQuotes(String S)
/*     ------------  */
{
    char	*p, *Start;
...
Set C50::MakeSubset(Attribute Att)
/*  ----------  */
{
    int		Bytes, b;
    char	*p;
...
void C50::StreamIn(String S, int n)
/*   --------  */
{
    while ( n-- ) *S++ = getc(TRf);
}
...
void C50::ResubErrs(Tree T, CaseNo Fp, CaseNo Lp)
/*   ---------  */
{
...
void C50::FindBounds(Tree T, CaseNo Fp, CaseNo Lp)
/*   --------  */
{
    int		v;
...
void C50::EstimateErrs(Tree T, CaseNo Fp, CaseNo Lp, int Sh, int Flags)
/*   ------------  */
{
    CaseNo	i, Bp, Ep, Missing;
    CaseCount	Cases=0, KnownCases, *BranchCases, MissingCases,
...
void C50::InsertParents(Tree T, Tree P)
/*   -------------  */
{
    DiscrValue	v;
...
void C50::CheckSubsets(Tree T, Boolean PruneDefaults)
/*   ------------  */
{
    Set		HoldValues;
...
float C50::ExtraErrs(CaseCount N, CaseCount E, ClassNo C)
/*    ---------  */
{
    ClassNo	EC;
...
float C50::RawExtraErrs(CaseCount N, CaseCount E)
/*    ------------  */
{
    float	Val0, Pr;
...
void C50::RestoreDistribs(Tree T)
/*   ---------------  */
{
    DiscrValue	v;
    ClassNo	c;
...
void C50::CompressBranches(Tree T)
/*   ----------------  */
{
...
void C50::SetGlobalUnitWeights(int LocalFlag)
/*   --------------------  */
{
...
Boolean C50::NewRule(Condition Cond[], int NCond, ClassNo TargetClass,
...
void C50::Uncompress(Byte *CL, int *UCL)
/*   ----------  */
{
    int		i, Entry=0;
    Byte	*p;
...
void C50::ListSort(int *L, int Fp, int Lp)
/*   --------  */
{
...
Boolean C50::SameRule(RuleNo r, Condition Cond[], int NConds, ClassNo TargetClass)
/*      --------  */
{
    int	d, i, Bytes;
...
void C50::FreeRules(CRuleSet RS)
/*   ---------  */
{
    int	ri;
...
void C50::PrintRules(CRuleSet RS, String Msg)
/*   ----------  */
{
    int	r;
...
void C50::PrintCondition(Condition C)
/*  --------------  */
{
...
void C50::ConstructRuleTree(CRuleSet RS)
/*   -----------------  */
{
    int		r, c;
    RuleNo	*All;
...
void C50::SetTestIndex(Condition C)
/*   ------------  */
{
    int		t;
    Condition	CC;
...
RuleTree C50::GrowRT(RuleNo *RR, int RRN, CRule *Rule)
/*       ------  */
{
    RuleTree	Node;
    RuleNo	r, *LR;
...
int C50::DesiredOutcome(CRule R, int TI)
/*  --------------  */
{
    int		c;
    Boolean	ContinTest;
...
int C50::SelectTest(RuleNo *RR, int RRN, CRule *Rule)
/*  ----------  */
{
    int		c, cc, ri;
    RuleNo	r;
...
void C50::FreeRuleTree(RuleTree RT)
/*   ------------  */
{
    int		b;
...
void C50::SiftRules(float EstErrRate)
/*   ---------  */
{
    RuleNo	r;
    int		d, *bp;
...
float C50::CondBits(Condition C)
/*    --------  */
{
    Attribute	Att;
    float	Code=0;
...
void C50::CoverClass(ClassNo Target)
/*   ----------  */
{
    CaseNo	i;
...
int C50::MessageLength(RuleNo NR, double RuleBits, float Errs)
/*  -------------  */
{
    return rint(100.0 *
...
void C50::UpdateDeltaErrs(CaseNo i, double Delta, RuleNo Toggle)
/*   ---------------  */
{
...
CaseCount C50::CalculateDeltaErrs()
/*        ------------------  */
{
    RuleNo	r;
    CaseNo	i;
...
void C50::SwapRule(RuleNo A, RuleNo B)
/*   --------  */
{
    CRule	Hold;
    Boolean	HoldIn;
...
void C50::GenerateLogs(int MaxN)
/*   ------------  */
{
    CaseNo	i;
...
void C50::Cachesort(CaseNo Fp, CaseNo Lp, SortRec *SRec)
/*   ---------  */
{
...
void C50::Quicksort(CaseNo Fp, CaseNo Lp, Attribute Att)
/*   ---------  */
{
    CaseNo	i, Middle, High;
    ContValue	Thresh, Val;
...
void C50::InitialiseBellNumbers()
/*   ---------------------  */
{
    DiscrValue	 n, k;
...
void C50::EvalSubset(Attribute Att, CaseCount Cases)
/*   ----------  */
{
...
void C50::Merge(DiscrValue x, DiscrValue y, CaseCount Cases)
/*   -----  */
{
    ClassNo	c;
    double	Entr=0;
...
void C50::EvaluatePair(DiscrValue x, DiscrValue y, CaseCount Cases)
/*   ------------  */
{
    ClassNo	c;
    double	Entr=0;
...
Boolean C50::SameDistribution(DiscrValue V1, DiscrValue V2)
/*	----------------  */
{
    ClassNo	c;
    CaseCount	D1, D2;
...
void C50::AddBlock(DiscrValue V1, DiscrValue V2)
/*   --------  */
{
    ClassNo	c;
    int		b;
...
void C50::MoveBlock(DiscrValue V1, DiscrValue V2)
/*   ---------  */
{
    ClassNo	c;
...
void C50::PrintSubset(Attribute Att, Set Ss)
/*   -----------  */
{
    DiscrValue	V1;
    Boolean	First=true;
...
void C50::SubsetTest(Tree Node, Attribute Att)
/*   -----------  */
{
    int	S, Bytes;
...
void C50::PrintTree(Tree T, String Title)
/*   ---------  */
{
    int s;
...
void C50::ShowBranch(int Sh, Tree T, DiscrValue v, DiscrValue BrNo)
/*   ----------  */
{
    DiscrValue	Pv, Last;
    Attribute	Att;
...
DiscrValue C50::Elements(Attribute Att, Set S, DiscrValue *Last)
/*         --------  */
{
...
void C50::Indent(int Sh, int BrNo)
/*   ------  */
{
    int	i;
...
Tree C50::Leaf(double *Freq, ClassNo NodeClass, CaseCount Cases, CaseCount Errors)
/*   ----  */
{
    Tree	Node;
    ClassNo	c;
...
void C50::Sprout(Tree T, DiscrValue Branches)
/*   ------  */
{
    T->Forks = Branches;
...
int C50::ExpandedLeafCount(Tree T)
/*  -----------------  */
{
    int		Sum=0;
    DiscrValue	v, Dummy;
...
void C50::PrintHeader(String Title)
/*   -----------  */
{
    char	TitleLine[80];
    time_t	clock;
...
char C50::ProcessOption(int Argc, char *Argv[], char *Options)
/*   -------------  */
{
    int		i;
    static int	OptNo=1;
...
void* C50::Prealloc(void *Present, size_t Bytes)
/*    --------  */
{
    void *p=Nil;
...
void* C50::Pcalloc(size_t Number, unsigned int Size)
/*    -------  */
{
    void *p=Nil;
...
void C50::FreeVector(void **V, int First, int Last)
/*   ----------  */
{
    if ( V )
    {
...
void C50::FreeLastCase(DataRec Case)
/*   ------------  */
{
    DataMem->Allocated--;
}
...
void C50::Error(int ErrNo, String S1, String S2)
/*   -----  */
{
...
FILE* C50::GetFile(String Extension, String RW)
/*    --------  */
{
    strcpy(Fn, FileStem);
    strcat(Fn, Extension);
...
int C50::Denominator(ContValue Val)
/*  -----------  */
{
...
int C50::DateToDay(String DS)	/*  Day 1 is 0000/03/01  */
/*  ---------  */
{
    int Year, Month, Day;
...
void C50::DayToDate(int Day, String Date)
/*   ---------  */
{
...
void C50::SecsToTime(int Secs, String Time)
/*   ----------  */
{
    int Hour, Mins;
...
int C50::TStampToMins(String TS)
/*  ------------  */
{
    int		Day, Sec, i;
...
void C50::CValToStr(ContValue CV, Attribute Att, String DS)
/*   ---------  */
{
    int		Mins;
...
void C50::Check(float Val, float Low, float High)
/*   -----  */
{
    if ( Val < Low || Val > High )
    {
...
int C50::UTF8CharWidth(unsigned char *U)
/*  -------------  */
{
...
int C50::wcswidth(const wchar_t *pwcs, size_t n)
{
  int w, width = 0;
...
float C50::SE(float sum, float sumsq, int no)
/*    --  */
{
    float mean;
